                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('division_name') is-invalid @enderror" name="division_name" id="validationServer03" aria-describedby="validationServer03Feedback">
